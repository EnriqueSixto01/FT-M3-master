...
async function problemA () {
  ...
  // AsyncAwait version
  const stnOne = await promisifiedReadFile('poem-one/stanza-01.txt')
  blue(stnOne)
...
async function problemB () {
  ...
  // AsyncAwait version
  const stnTwo = await promisifiedReadFile('poem-one/stanza-02.txt');
  blue(stnTwo);
  const stnThree = await promisifiedReadFile('poem-one/stanza-03.txt')
  blue(stnThree)
...
async function problemD () {
  ...
  // AsyncAwait version
  try{
    const stnFour = await promisifiedReadFile('poem-one/wrong-file-name.txt');
    blue(stnFour)
  }catch(err){
    magenta(err)
  }
...
async function problemE () {
  ...
  // AsyncAwait version
  try{
    const sntThree = await promisifiedReadFile('poem-one/stanza-03.txt');
    blue(sntThree)
    const stnFour = await promisifiedReadFile('poem-one/wrong-file-name.txt');
    blue(stnFour)
  } catch(err){
